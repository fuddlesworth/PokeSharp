...
public class TemplateException : CoreException
{
    ...
    public string TemplateName =>
        Context.TryGetValue("TemplateName", out var name) ? name?.ToString() ?? "" : "";
...
public class SystemManagementException : CoreException
{
    ...
    public string SystemName =>
        Context.TryGetValue("SystemName", out var name) ? name?.ToString() ?? "" : "";
...
public class ComponentRegistrationException : CoreException
{
    ...
    public string ComponentType =>
        Context.TryGetValue("ComponentType", out var type) ? type?.ToString() ?? "" : "";
...
public class EventBusException : CoreException
{
    ...
    public string EventType =>
        Context.TryGetValue("EventType", out var type) ? type?.ToString() ?? "" : "";
...
public class ModdingException : CoreException
{
    ...
    public string ModName =>
        Context.TryGetValue("ModName", out var name) ? name?.ToString() ?? "" : "";
