...
/// <summary>
    ...
    /// </summary>mary>
    public void DrawSectionFoldBoxes(
        int outputY,
        int lineHeight,
    ...
    *
    ...
    /// </summary>howing current position.
    /// </summary>
    public void DrawScrollIndicator(int yPos, int
    lineHeight
    ,
    ConsoleOutput
    output
    ...
    *
    ...
    scrollBarX
    ,
    thumbY, scrol/// <summary>
    ///     Draws a right-pointing triangle (for collapsed sections).
    /// </summary>gle (for collapsed sections).
    /// </summary>
    public void DrawRightTriangle(int leftX, int centerY
    ,
    int
    width
    ,
    ...
    *
    ...
    _pixel
    ,
n Rectangle(x, y, width, height), color);
    }
}
