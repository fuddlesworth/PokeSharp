...
public class DocumentationProvider
{
    ...
    private Documentation ParseDescription(Documentation doc, CompletionDescription description)
    {
        ...
        foreach (var part in description.TaggedParts)
        {
            ...
            else if (part.Tag == "Param")
            {
                ...
                var paramText = part.Text;
                var colonIndex = paramText.IndexOf(':');
                if (colonIndex > 0)
                {
                    var paramName = paramText.Substring(0, colonIndex).Trim();
                    var paramDesc = paramText.Substring(colonIndex + 1).Trim();
    ...
    public string FormatForDisplay(Documentation doc, int maxWidth = 60)
    {
        ...
        var topBorder = "╔" + separator + "╗";
        var bottomBorder = "╚" + separator + "╝";
