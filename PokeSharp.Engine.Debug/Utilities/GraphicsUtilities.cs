...
public static class GraphicsUtilities
{
    ...
    public static void DrawRectangle(SpriteBatch spriteBatch, Texture2D pixel, int x, int y, int width, int height, Color color)
    {
    ...
    /// <param name="color">Color of the rectangle.</param>
    public static void DrawRectangle(SpriteBatch spriteBatch, Texture2D pixel, Vector2 position, Vector2 size, Color color)
    {
    ...
    /// <param name="color">Color of the rectangle.</param>
    public static void DrawRectangle(SpriteBatch spriteBatch, Texture2D pixel, Rectangle rectangle, Color color)
    {
