...
public static class AudioConstants
{
    ...
    public static float ClampVolume(float value) => Math.Clamp(value, MinVolume, MaxVolume);
    ...
    public static float ClampPan(float value) => Math.Clamp(value, MinPan, MaxPan);
}
