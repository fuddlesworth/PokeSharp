...
namespace MonoBallFramework.Game.Engine.Debug.Console.Configuration;
...
public record ConsoleConfig
{
    ...
    /// </summary>
    public ConsoleConfig WithLogging(bool enabled)
    {
    ...
    /// </summary>
    public ConsoleConfig WithMinimumLogLevel(LogLevel level)
    {
