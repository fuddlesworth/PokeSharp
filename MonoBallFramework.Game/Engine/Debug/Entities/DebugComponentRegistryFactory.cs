...
///     Scans assemblies for struct types in MonoBallFramework.Game.Components namespaces.
/// </summary>
public static class DebugComponentRegistryFactory
{
    ...
    /// <summary>
    ///     Auto-discovers component types from assemblies matching MonoBallFramework.Game.Components namespace.
    /// </summary>
    ...
    private static string DetermineCategoryFromNamespace(string ns)
    {
        ...
        // e.g., "MonoBallFramework.Game.Components.Maps" -> "Maps"
        // e.g., "MonoBallFramework.Game.Components.Movement" -> "Movement"
