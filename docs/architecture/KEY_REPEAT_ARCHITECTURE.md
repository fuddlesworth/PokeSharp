...
- `PokeSharp.Engine.UI.Debug/Input/InputState.cs` - Core implementation
- `PokeSharp.Engine.UI.Debug/Components/Controls/CommandInput.cs` - Example usage
- `PokeSharp.Engine.UI.Debug/Components/Debug/ConsolePanel.cs` - Example usage
