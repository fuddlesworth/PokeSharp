...
- **New**: `/PokeSharp.Engine.UI.Debug/Components/Controls/HintBar.cs`
- **Updated**: `/PokeSharp.Engine.UI.Debug/Components/Controls/TextEditor.cs`
  - Fixed `EnsureCursorVisible()` to prevent unwanted scrolling
  - Removed inline hint rendering
  - Added `IsMultiLine` property
- **Updated**: `/PokeSharp.Engine.UI.Debug/Components/Debug/ConsolePanel.cs`
