...
public class TextEditorHistory
{
    ...
    public void LoadFromDisk()
    {
        ...
        try
        {
            var loaded = Utilities.HistoryPersistence.LoadHistory();
            _history.Clear();
    ...
    public void SaveToDisk()
    {
        ...
        try
        {
            Utilities.HistoryPersistence.SaveHistory(_history);
        }
        catch (Exception ex)
        {
            // Log error but don't throw - history persistence is not critical
